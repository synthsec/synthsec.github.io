...
tl;dr: We found four vulnerabilities in NagiosXI, and chained them together to create a root RCE exploit, available [here](https://www.exploit-db.com/exploits/44560/). Vulnerability chaining can increase the risk posed by individual vulns, it takes a village to raise a root RCE etc. etc. If you're running NagiosXI, <= 5.4, update.
